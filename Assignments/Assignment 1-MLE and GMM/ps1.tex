...
\midrule
Plain Logit & 12982.80 & -3.44 & 0.52 & 0.20 & 0.15 & -0.43 \\
\bottomrule
\end{tabular}
}
...
Model & NLL & $\beta_1$ & $\beta_2$ & $\alpha$ & $D_{12}$ & Avg. own dist. elas. \\
\midrule
Plain Logit & 12982.80 & -3.44 & 0.52 & 0.20 & 0.15 & -0.43 \\\n$\text{Only-}\xi$ & 14260.39 & -- & -- & -- & -- & -- \\\nExpanded Logit (MC, R=100) & 12982.80 & -3.44 & 0.52 & 0.20 & 0.15 & -0.43 \\\nMixed Logit (GH, M=20) & 12982.80 & -3.44 & 0.52 & 0.20 & 0.15 & -0.43 \\
\bottomrule
\end{tabular}
}
\caption{Estimation results for logit models.}
...
\medskip
\noindent
The instruments $z_{ij}$ need to be variables that exogenosuly shift the observed choices. We might plausibly just use our observables to instrument themselves.
...
Model & NLL & $\beta_1$ & $\beta_2$ & $\alpha$ & $D_{12}$ & Avg. own dist. elas. \\
\midrule
Plain Logit & 12982.80 & -3.44 & 0.52 & 0.20 & 0.15 & -0.43 \\\n$\text{Only-}\xi$ & 14260.39 & -- & -- & -- & -- & -- \\\n MSM (GH, M=20) & -- & -3.48 & 0.53 & 0.20 & 0.15 & -0.43 \\
\bottomrule
\end{tabular}
}
\caption{Estimation results for logit models.}
...
Model & NLL & $\beta_1$ & $\beta_2$ & $\alpha$ & $D_{12}$ & Avg. own dist. elas. \\
\midrule
Plain Logit & 12982.80 & -3.44 & 0.52 & 0.20 & 0.15 & -0.43 \\\n$\text{Only-}\xi$ & 14260.39 & -- & -- & -- & -- & -- \\\n MSM (GH, M=20) & -- & -3.48 & 0.53 & 0.20 & 0.15 & -0.43 \\\n Efficient MSM (GH, M=20)) & -- & -3.48 & 0.53 & 0.20 & 0.15 & -0.43 \\
\bottomrule
\end{tabular}
}
\caption{Estimation results for logit models.}
