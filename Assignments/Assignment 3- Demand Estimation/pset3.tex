...
\[
y_{jt}= \beta x_{jt} + \beta_{sat}Satellite_{jt} +  \alpha p_{jt} + \xi_{jt},
\]
...
\[
y_{jt}= \beta x_{jt} + \beta_{sat}Satellite_{jt} + \alpha \hat p_{jt} + \varepsilon_{jt},
\]
...
I instrument price using the excluded cost shifter $w$, while the exogenous regressors $x$, $\ln s_{j|g}$, and $\ln S_g$ enter directly in the equation.
...
From\\To & 1 & 2 & 3 & 4\\
\hline
1 & 0.000 & 0.205 & 0.123 & 0.119\\
2 & 0.196 & 0.000 & 0.123 & 0.120\\
3 & 0.124 & 0.131 & 0.000 & 0.186\\
4 & 0.122 & 0.129 & 0.193 & 0.000\\
\hline
\end{tabular}
\end{table}
...
From\\To & 1 & 2 & 3 & 4\\
\hline
1 & 0.000 & 0.535 & 0.075 & 0.069\\
2 & 0.510 & 0.000 & 0.077 & 0.075\\
3 & 0.071 & 0.075 & 0.000 & 0.533\\
4 & 0.066 & 0.074 & 0.554 & 0.000\\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}{lcccc}\hline From\\To & 1 & 2 & 3 & 4\\\hline
1 & 0.000 & 0.261 & 0.130 & 0.125\\
2 & 0.249 & 0.000 & 0.131 & 0.127\\
3 & 0.114 & 0.120 & 0.000 & 0.151\\
4 & 0.112 & 0.119 & 0.155 & 0.000\\
\hline\end{tabular}\end{table}
...
Up to this point, we normalised the market size to $M_t = 1$ without loss of generality because we were comparing objects like market shares, elasticities, or percentage price changes. These are all {per-consumer} or {per-market} objects, so scaling the total number of consumers did not affect any of the qualitative conclusions.
