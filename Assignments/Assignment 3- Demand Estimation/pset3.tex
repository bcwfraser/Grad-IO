...
\midrule
Beta on $x$ & 0.621\\
Alpha on price & -0.509\\
Sigma (satellite) & 0.680\\
Sigma (wired) & 0.687\\
\bottomrule
\end{tabular}
\end{table}
...
From\\To & 1 & 2 & 3 & 4\\
\hline
1 & -1.000 & 0.201 & 0.125 & 0.120\\
2 & 0.192 & -1.000 & 0.125 & 0.122\\
3 & 0.120 & 0.127 & -1.000 & 0.195\\
4 & 0.118 & 0.125 & 0.202 & -1.000\\
\hline
\end{tabular}
\end{table}
...
From\\To & 1 & 2 & 3 & 4\\
\hline
1 & -1.000 & 0.550 & 0.074 & 0.069\\
2 & 0.523 & -1.000 & 0.076 & 0.075\\
3 & 0.072 & 0.076 & -1.000 & 0.530\\
4 & 0.067 & 0.076 & 0.550 & -1.000\\
\hline
\end{tabular}
\end{table}
...
Note that this coefficient should have a ``true'' mean of zero and a variance of $\sqrt{2} \approx 1.414$, since under the DGP $\beta_i^{satellite}$ and $\beta_i^{wired}$ were drawn independently from $\mathcal{N}(4,1)$.
...
\begin{table}[H]
\centering
\caption{Random coefficients logit estimates}
\begin{tabular}{lccc}
\hline
Parameter & Demand only & Demand+Supply & Optimal IV\\
\hline
$\beta_x$ & 0.801 (0.042) & 0.800 (0.042) & 0.781 (0.032)\\
$\alpha_{price}$ & -1.888 (0.085) & -1.888 (0.086) & -1.875 (0.067)\\
Mean on satellite & -0.232 (0.202) & -0.228 (0.201) & 0.081 (0.055)\\
SD on satellite & 1.367 (0.444) & 1.358 (0.443) & 0.444 (0.216)\\
\hline
\end{tabular}
\end{table}
...
1 & -1.000 & 0.259 & 0.130 & 0.125\\
2 & 0.248 & -1.000 & 0.131 & 0.127\\
3 & 0.114 & 0.120 & -1.000 & 0.151\\
4 & 0.113 & 0.119 & 0.155 & -1.000\\
\hline\end{tabular}\end{table}
